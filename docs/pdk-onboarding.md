...
- `pdk-validate` 报告现在包含 `summary` 与 `checks`，用于快速查看 cell/timing/interconnect/characterization 覆盖数量，以及 required cell kind、required timing、required interconnect timing、named timing、characterized arcs、PTL forbidden ranges 等分项状态。

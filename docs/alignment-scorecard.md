...
| J-04 | JoSIM alignment | should | 5 | Linux same-platform approved baseline is present and Linux no-regression gate is enabled by default. | `.github/workflows/ci.yml` | (future Linux waveform regression tests) | (future Linux waveform job) | `docs/full-alignment-plan.md` |
